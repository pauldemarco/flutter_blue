...
@dynamic deviceMacsArray, deviceMacsArray_Count;

typedef struct ProtosScanSettings__storage_ {
  uint32_t _has_storage_[1];
  int32_t androidScanMode;
  NSMutableArray *serviceUuidsArray;
  NSMutableArray *deviceMacsArray;
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      {
        .name = "deviceMacsArray",
        .dataTypeSpecific.clazz = Nil,
        .number = ProtosScanSettings_FieldNumber_DeviceMacsArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(ProtosScanSettings__storage_, deviceMacsArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeString,
      },
    };
