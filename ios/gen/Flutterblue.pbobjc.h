...
typedef GPB_ENUM(ProtosScanSettings_FieldNumber) {
  ...
  ProtosScanSettings_FieldNumber_DeviceMacsArray = 4,
};
...
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<NSString*> *deviceMacsArray;
/** The number of items in @c deviceMacsArray without causing the array to be created. */
@property(nonatomic, readonly) NSUInteger deviceMacsArray_Count;
