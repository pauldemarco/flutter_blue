...
typedef GPB_ENUM(ProtosRssiRequest_FieldNumber) {
  ProtosRssiRequest_FieldNumber_RemoteId = 1,
};

GPB_FINAL @interface ProtosRssiRequest : GPBMessage
...
typedef GPB_ENUM(ProtosRssiResponse_FieldNumber) {
  ProtosRssiResponse_FieldNumber_RemoteId = 1,
  ProtosRssiResponse_FieldNumber_Rssi = 2,
};

GPB_FINAL @interface ProtosRssiResponse : GPBMessage
