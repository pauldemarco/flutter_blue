...
@$core.Deprecated('Use isReadyToSendWriteWithoutResponseDescriptor instead')
const IsReadyToSendWriteWithoutResponse$json = const {
  '1': 'IsReadyToSendWriteWithoutResponse',
  '2': const [
    const {'1': 'remote_id', '3': 1, '4': 1, '5': 9, '10': 'remoteId'},
  ],
};

/// Descriptor for `IsReadyToSendWriteWithoutResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List isReadyToSendWriteWithoutResponseDescriptor = $convert.base64Decode('CiFJc1JlYWR5VG9TZW5kV3JpdGVXaXRob3V0UmVzcG9uc2USGwoJcmVtb3RlX2lkGAEgASgJUghyZW1vdGVJZA==');
