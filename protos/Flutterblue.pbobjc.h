...
typedef GPB_ENUM(ProtosIsReadyToSendWriteWithoutResponse_FieldNumber) {
  ProtosIsReadyToSendWriteWithoutResponse_FieldNumber_RemoteId = 1,
};

@interface ProtosIsReadyToSendWriteWithoutResponse : GPBMessage
