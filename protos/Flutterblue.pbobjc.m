...
#pragma mark - ProtosIsReadyToSendWriteWithoutResponse

@implementation ProtosIsReadyToSendWriteWithoutResponse

@dynamic remoteId;

typedef struct ProtosIsReadyToSendWriteWithoutResponse__storage_ {
  uint32_t _has_storage_[1];
  NSString *remoteId;
} ProtosIsReadyToSendWriteWithoutResponse__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "remoteId",
        .dataTypeSpecific.className = NULL,
        .number = ProtosIsReadyToSendWriteWithoutResponse_FieldNumber_RemoteId,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(ProtosIsReadyToSendWriteWithoutResponse__storage_, remoteId),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeString,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[ProtosIsReadyToSendWriteWithoutResponse class]
                                     rootClass:[ProtosFlutterblueRoot class]
                                          file:ProtosFlutterblueRoot_FileDescriptor()
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(ProtosIsReadyToSendWriteWithoutResponse__storage_)
                                         flags:GPBDescriptorInitializationFlag_None];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
