...
class IsReadyToSendWriteWithoutResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IsReadyToSendWriteWithoutResponse', createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'remoteId')
    ..hasRequiredFields = false
  ;

  IsReadyToSendWriteWithoutResponse._() : super();
  factory IsReadyToSendWriteWithoutResponse({
    $core.String? remoteId,
  }) {
    final _result = create();
    if (remoteId != null) {
  ...
  factory IsReadyToSendWriteWithoutResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory IsReadyToSendWriteWithoutResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  IsReadyToSendWriteWithoutResponse clone() => IsReadyToSendWriteWithoutResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IsReadyToSendWriteWithoutResponse copyWith(void Function(IsReadyToSendWriteWithoutResponse) updates) => super.copyWith((message) => updates(message as IsReadyToSendWriteWithoutResponse)) as IsReadyToSendWriteWithoutResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static IsReadyToSendWriteWithoutResponse create() => IsReadyToSendWriteWithoutResponse._();
  IsReadyToSendWriteWithoutResponse createEmptyInstance() => create();
  static $pb.PbList<IsReadyToSendWriteWithoutResponse> createRepeated() => $pb.PbList<IsReadyToSendWriteWithoutResponse>();
  @$core.pragma('dart2js:noInline')
  static IsReadyToSendWriteWithoutResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<IsReadyToSendWriteWithoutResponse>(create);
  static IsReadyToSendWriteWithoutResponse? _defaultInstance;
