...
class RssiRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RssiRequest', createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'remoteId')
    ..hasRequiredFields = false
  ;
  ...
  factory RssiRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RssiRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  RssiRequest clone() => RssiRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RssiRequest copyWith(void Function(RssiRequest) updates) => super.copyWith((message) => updates(message as RssiRequest)) as RssiRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static RssiRequest create() => RssiRequest._();
  RssiRequest createEmptyInstance() => create();
  static $pb.PbList<RssiRequest> createRepeated() => $pb.PbList<RssiRequest>();
  @$core.pragma('dart2js:noInline')
  static RssiRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RssiRequest>(create);
  static RssiRequest _defaultInstance;
