...
@$core.Deprecated('Use rssiRequestDescriptor instead')
const RssiRequest$json = const {
  '1': 'RssiRequest',
  '2': const [
    const {'1': 'remote_id', '3': 1, '4': 1, '5': 9, '10': 'remoteId'},
  ],
...
/// Descriptor for `RssiRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List rssiRequestDescriptor = $convert.base64Decode('CgtSc3NpUmVxdWVzdBIbCglyZW1vdGVfaWQYASABKAlSCHJlbW90ZUlk');
...
final $typed_data.Uint8List rssiResponseDescriptor = $convert.base64Decode('CgxSc3NpUmVzcG9uc2USGwoJcmVtb3RlX2lkGAEgASgJUghyZW1vdGVJZBISCgRyc3NpGAIgASgFUgRyc3Np');
